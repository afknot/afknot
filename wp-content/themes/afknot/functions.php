<?php
/**
 * A.F. Knot functions and definitions
 *
...
if ( ! function_exists( 'afknot_setup' ) ) :
	/**
	 ...
	 */
	function afknot_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on A.F. Knot, use a find and replace
		 * to change 'afknot' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'afknot', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'afknot' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'afknot_custom_background_args', array(
...
add_action( 'after_setup_theme', 'afknot_setup' );
 ...
 */
function afknot_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'afknot_content_width', 640 );
}
add_action( 'after_setup_theme', 'afknot_content_width', 0 );
 ...
 */
function afknot_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'afknot' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'afknot' ),
