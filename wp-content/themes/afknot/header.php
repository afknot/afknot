...
<head>
	...
	<link rel="shortcut icon" href="<?php echo esc_url( home_url( '/' ) ); ?>/wp-content/themes/afknot/favicon.ico" type="image/x-icon">
	<link rel="icon" href="<?php echo esc_url( home_url( '/' ) ); ?>/wp-content/themes/afknot/favicon.ico" type="image/x-icon">
	<?php wp_head(); ?>
</head>
